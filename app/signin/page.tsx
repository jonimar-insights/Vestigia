    ...
    >
      <div className="w-full max-w-sm text-center bg-background/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl relative z-20">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 rounded-lg border border-border bg-surface px-4 py-3 text-sm font-medium hover:bg-surface-hover transition-colors"
        >
